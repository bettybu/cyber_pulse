...
rss_feeds = [
    ...
    "https://www.sans.org/rss/dfir.xml",
    ...
    <div class="container">
        <header>
            <h1>🛡️ OSINT & Cyber Daily Feed</h1>
                <div class="subtitle">Daily cybersecurity news overview, updated every day at 8:00 AM - your morning coffee with a Cyber Cow ☕ 🐂<br>Last update: {today_date}</div>
        </header>
